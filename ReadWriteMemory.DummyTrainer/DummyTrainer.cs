...
internal sealed class DummyTrainer
{
    ...
    internal static async Task Main()
    {
        ...
        while (true)
        {
            ...
            else if (await Hotkeys.Hotkeys.KeyPressedAsync(Hotkeys.Hotkeys.Key.VK_F2))
            {
                stopwatch.Start();
            ...
            else if (await Hotkeys.Hotkeys.KeyPressedAsync(Hotkeys.Hotkeys.Key.VK_F3))
            {
                stopwatch.Start();
            ...
            else if (await Hotkeys.Hotkeys.KeyPressedAsync(Hotkeys.Hotkeys.Key.VK_F4))
            {
                stopwatch.Start();
            ...
            else if (await Hotkeys.Hotkeys.KeyPressedAsync(Hotkeys.Hotkeys.Key.VK_F5))
            {
                stopwatch.Start();
            ...
            else if (await Hotkeys.Hotkeys.KeyPressedAsync(Hotkeys.Hotkeys.Key.VK_F6))
            {
                stopwatch.Start();

                memory.WriteProcessMemory(_hp, 50f);
            ...
            else if (await Hotkeys.Hotkeys.KeyPressedAsync(Hotkeys.Hotkeys.Key.VK_F7))
            {
                stopwatch.Start();

                memory.ReadProcessMemory(_hp, Mem.MemoryDataTypes.Float, out var value);
