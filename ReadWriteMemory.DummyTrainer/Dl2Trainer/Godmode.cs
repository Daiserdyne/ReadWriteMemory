...
internal sealed class Godmode : IMemoryTrainer
{
    ...
    private readonly byte[] _godModeBytes = new byte[] { 0x83, 0xBB, 0x50, 0x01, 0x00, 0x00, 0x01, 0x0F, 0x85, 0x08, 0x00, 0x00, 0x00, 0xF3, 0x0F, 0x10, 0x35, 0xEB, 0x07, 0x00, 0x00, 0xF3, 0x0F, 0x11, 0xB3, 0x78, 0x01, 0x00, 0x00, };
    public ushort Id => 0;
    ...
    {
        await _memory.CreateOrResumeCodeCaveAsync(_healthFunctionAddress, _godModeBytes, 8, 23);
    }
